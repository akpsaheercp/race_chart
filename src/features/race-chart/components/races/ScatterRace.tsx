...
export default function ScatterRace({ svgRef, config, isPlaying, currentTimeIndex, dimensions, dateGroups }: RaceProps) {
  ...
  useEffect(() => {
    ...
    const renderFrame = (index: number) => {
      ...
      const rScale = d3.scaleSqrt().domain([0, maxVal]).range([5, 40]);
      ...
      const bubbles = g.selectAll<SVGGElement, any>('.scatter-bubble')
